...
function Bestiary(config) {
     ...
     *
     * @param  mixed name String seperating terms with spaces or an array of terms
     */
     ...
     *
     * @param  string area The area name to search for
     */
     ...
     *
     * @param  int id A slayer category id
     */
     ...
     *
     * @param  id weeknessId A weekeness id
     */
     ...
     *
     * @param  int min The minimum level to lookup
     * @param  int max The maximum level to lookup
     */
